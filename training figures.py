...
"/Users/nikikotecha/ray_results/PPO/PPO_MultiAgentInvManagementDiv_60221_00000_0_2023-11-20_11-53-10/result.json"
]
...
single_agent = [#"/Users/nikikotecha/ray_results/PPO/PPO_MultiAgentInvManagementDiv_1466d_00000_0_2023-11-18_13-47-57/result.json", 
                ...
                #"/Users/nikikotecha/ray_results/PPO_MultiAgentInvManagementDiv_2023-11-20_10-37-17pwgqlbgr/result.json" this was when we did max(o, rescaled s values)
                 ...
                 "/Users/nikikotecha/ray_results/PPO/PPO_MultiAgentInvManagementDiv_82dea_00000_0_2023-11-21_19-23-55/result.json", #this was env3run file with optimised parameters 
...
def training_figures(file_paths_list, iteration_to_check):
    ...
    for file_paths , label in zip(file_paths_list, ['Multi Agent', 'Multi Agent', 'Multi Agent', 'Single Agent']):
        all_rewards = []
...
file_paths_list = [single_agent, single]
highest_avg_reward_path = training_figures(file_paths_list, iteration_to_check)
